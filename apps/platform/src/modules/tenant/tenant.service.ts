...
import { DatabaseService } from '../../infrastructure/persistence/drizzle/database.service';
import {
  tenantTable,
  NewTenant,
  Tenant,
} from '../../infrastructure/persistence/tenant/tenant.schema';
...
export class TenantService {
  ...
  private async checkSchemaExists(
    ...
    const db = await this.db.setupTenantDbConnection('system');
